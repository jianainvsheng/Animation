...
import com.gome.pull.down.widget.ProgressWheel;

public class GomeFooterLoadLayout extends FooterBaseLoadLayout {
    private ProgressWheel loadingView;
    private TextView loadStateTextView;
    private String mInitText;
    private String mReleaseToLoadText;

    public GomeFooterLoadLayout(Context context) {
        super(context);
        this.mInitText = "上拉加载";
    ...
    public GomeFooterLoadLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
