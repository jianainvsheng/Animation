...
//
///**
// * Created by yangjian on 2017/10/23.
// */
//
//public class PullDownLayoutView  extends RelativeLayout {
//
//    public static final String TAG = "PullDownLayoutView";
//    // 初始状态
...
//    }
//
//    public PullDownLayoutView(Context context)
//    {
//        super(context);
//        initView(context);
//    }
//
//    public PullDownLayoutView(Context context, AttributeSet attrs)
//    {
//        super(context, attrs);
//        initView(context);
//    }
//
//    public PullDownLayoutView(Context context, AttributeSet attrs, int defStyle)
//    {
...
//                //loadStateTextView.setText(R.string.load_noting);
...
//                {
//                    if (pullDownY > 0
//                            || (((PullableListener) pullableView).canPullDown(ev)
...
//                        if(pullDownY > 8){
//                            if(replyListener != null){
//                                replyListener.onPullDownStart();
//                            }
//                        }
//
//                    } else if (pullUpY < 0
//                            || (((PullableListener) pullableView).canPullUp(ev) && canPullUp && state != REFRESHING))
//                    {
//                        // 可以上拉，正在刷新时不能上拉
...
//            // 刷新操作
//            if (mListener != null)
//                mListener.onRefresh(PullDownLayoutView.this);
//            hide();
//        }
//
//        @Override
...
//    {
//        // 初始化下拉布局
//        //pullView = LayoutInflater.from(getContext()).
...
//        //pullUpView = LayoutInflater.from(getContext()).
...
//         * 刷新操作
//         */
//        void onRefresh(PullDownLayoutView pullToRefreshLayout);
//
//        /**
//         * 加载操作
//         */
//        void onLoadMore(PullDownLayoutView pullToRefreshLayout);
//    }
//
