...
public class PullableListView extends ListView implements Pullable, OnScrollListener {
    ...
    private PullableListView.OnMyListViewScrollListener mOnMyListViewScrollListener;
    ...
    private PullableListView.PullableScrollCallBack pullableScrollCallBack;
...
//        }
    ...
    public void onRefreshComplete() {
        if(this.getParent() instanceof PullToRefreshLayout) {
            PullToRefreshLayout pullToRefreshLayout = (PullToRefreshLayout)this.getParent();
    ...
    public void setOnScrollListener(PullableListView.OnMyListViewScrollListener listener) {
    ...
    public void setPullableScrollCallBack(PullableListView.PullableScrollCallBack pullableScrollCallBack) {
